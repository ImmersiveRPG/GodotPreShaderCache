...
signal over_frame_budget(used_usect, budget_usec)
...
var _fn_get_frame_start_ticks_usec : FuncRef
...
func _main_iteration_start() -> void:
	_main_iteration_start_ticks = _fn_get_frame_start_ticks_usec.call_func()
